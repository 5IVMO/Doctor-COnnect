...
/**
 * Created by hii on 2/18/2017.
 */

public class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.MyViewHolder>{
    private Context mContext;
    private List<com.example.hii.doctorconnect.Patient.Home> messageList;
    ...
    public HomeAdapter(Context mContext,List<com.example.hii.doctorconnect.Patient.Home> messageList){
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        com.example.hii.doctorconnect.Patient.Home home = messageList.get(position);
