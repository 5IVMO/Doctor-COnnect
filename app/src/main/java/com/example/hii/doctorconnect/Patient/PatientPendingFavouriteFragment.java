 ...
 */
public class PatientPendingFavouriteFragment extends Fragment {
    ...
    private void prepareAlbums() {
        ...
        Doctor a=new Doctor("Dr. Owais","Liaquat National","Dentist",4,covers[11]);
        doctorList.add(a);

        a=new Doctor("Dr. Subhan","Liaquat National","Dentist",4,covers[13]);
        doctorList.add(a);
